...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView logoWork;

  @NonNull
  public final RelativeLayout rela;

  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView, @NonNull ImageView logoWork,
      @NonNull RelativeLayout rela) {
    this.rootView = rootView;
    this.logoWork = logoWork;
    this.rela = rela;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.logoWork;
      ImageView logoWork = ViewBindings.findChildViewById(rootView, id);
      if (logoWork == null) {
        break missingId;
      }
      ...
      return new ActivitySplashScreenBinding((RelativeLayout) rootView, logoWork, rela);
    }
