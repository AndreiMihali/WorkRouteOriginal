...
public final class ActivityChatsBinding implements ViewBinding {
  ...
  private ActivityChatsBinding(@NonNull RelativeLayout rootView,
      @NonNull ProgressBar progressCircular, @NonNull RecyclerView recyclerChats,
      @NonNull MaterialToolbar toolbar, @NonNull TextView txtNull) {
  ...
  public static ActivityChatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChatsBinding((RelativeLayout) rootView, progressCircular, recyclerChats,
          toolbar, txtNull);
    }
